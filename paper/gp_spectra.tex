...
\begin{figure}
    ...
    \caption{Recovery test. Artificially masking the 15789 \AA\ Cerium window (indicated by vertical dotted lines) for the lowest-SNR star results in a model prediction (dark-grey shaded region) that is entirely in agreement with the measured spectrum (solid black line) once measurement uncertainties are taken into account (light-grey shaded region).}
