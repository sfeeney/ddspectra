...
%In section 4.2 we demonstrated that our procedure returns a quantitative measure of the correlation structure of the data, which has an ensemble of data-driven scientific applications, some of which we highlight below. In Section 4.3 we quantified the information content of the abundance windows that we examine.  
